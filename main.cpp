...
#include "Task29/Task29.h"
#include "Task30/Task30.h"
...
int main(int argc, char *argv[]) {
    ...
    long accuracy_testing[] = {100, 10000000, 400000000};
    for (int i = 0; i < 8; ++i) {
        for (int j = 0; j < 3; ++j) {
            task29->execute(threads[i], accuracy_testing[j]);
        }
    }

    cout << "\n\n\nTASK_30";
    Task30 *task30 = new Task30();
    task30->execute(argc, argv, 4);
}
